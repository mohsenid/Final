...
if (isset($_POST['edit_category'])) {
    ...
    if (trim($_POST['title']) != "") {
        ...
        header("Location:edit_category.php?id=$category_id&err_msg= The title field is required ");
        exit();
    }
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form method="post">
                ...
                <button type="submit" name="edit_category" class="btn btn-outline-primary"> Edit </button>
            </form>
